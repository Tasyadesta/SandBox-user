           ...
           <div class="modal-dialog">
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php $__currentLoopData = $dataMateri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($kelas->id); ?></td>
                    <td><?php echo e($kelas->nama_materi); ?></td>
                    <?php $__currentLoopData = $datakelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($k->id == $kelas->kelas_id): ?>
                    <td> <?php echo e($k->nama_kelas); ?> </td>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td><img src="<?php echo e($kelas->foto); ?>" width="150"></td>
                    <td> <?php echo e($kelas->keterangan); ?> </td>
                    <td> <?php echo e($kelas->video); ?> </td>
                    <td> <?php echo e($kelas->modul); ?> </td>
                    <td> <?php echo e($kelas->created_at); ?> </td>
                    <td class="td-actions">
                      
                      <a class="btn btn-small btn-warning" data-toggle="modal" data-target="#edit<?php echo e($kelas->id); ?>"><i class="btn-icon-only icon-pencil"> </i></a>
                      <div id="edit<?php echo e($kelas->id); ?>" class="modal fade" role="dialog">
                   <div class="modal-dialog">
                       <div class="modal-content">
                           <div class="modal-header">
                               <button type="button" class="close" data-dismiss="modal">&times;</button>
                           ...
                           <?php echo csrf_field(); ?>
                               <div class="modal-body">
                                ...
                                <div class="from-group">
                                 ...
                                 <div class="from-group">
                                     <label class="control-label" for="nm_brg" style="color: black"> Nama Materi: </label>
                                     <input type="text" name="nama_materi" class="from-control" id="nm_brg" style="color: black" value="<?php echo e($kelas->nama_materi); ?>" required>
                                 </div>
                                 <div class="from-group">
                                   <label class="control-label" for="nm_brg" style="color: black"> Keterangan: </label>
                                   <input type="text" name="keterangan" class="from-control" id="nm_brg" style="color: black" value="<?php echo e($kelas->keterangan); ?>" required>
                               </div>
                               <div class="from-group">
                                <label class="control-label" for="nm_brg" style="color: black"> Link Foto: </label>
                                <input type="text" name="foto" class="from-control" id="nm_brg" style="color: black" placeholder="" value="<?php echo e($kelas->foto); ?>" required>
                            </div>
                               <div class="from-group">
                                 <label class="control-label" for="nm_brg" style="color: black"> Link Video: </label>
                                 <input type="text" name="video" class="from-control" id="nm_brg" style="color: black" placeholder="Youtube (embed)" value="<?php echo e($kelas->video); ?>"required>
                             </div>
                             <div class="from-group">
                                <label class="control-label" for="nm_brg" style="color: black"> Link modul: </label>
                                <input type="text" name="modul" class="from-control" id="nm_brg" style="color: black" value="<?php echo e($kelas->modul); ?>" required>
                            </div>
                      ...
                      <a class="btn btn-small btn-danger" data-toggle="modal" data-target="#delete<?php echo e($kelas->id); ?>"><i class="btn-icon-only icon-trash"> </i></a>
                      <div id="delete<?php echo e($kelas->id); ?>" class="modal fade" role="dialog">
                   <div class="modal-dialog">
                       <div class="modal-content">
                           <div class="modal-header">
                               <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<?php /**PATH F:\polos\resources\views/admin/materi.blade.php ENDPATH**/ ?>