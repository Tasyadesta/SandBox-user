              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    <div class="stat"> <i class="icon-user"></i> <span class="value">{{ $count }}</span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-shopping-cart"></i> <span class="value">{{ $countorder }}</span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-book"></i> <span class="value">{{ $countbook }}</span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-bookmark"></i> <span class="value">{{ $countkelas }}</span> </div>
                    <!-- .stat --> 
                  </div>
                </div>
                <!-- /widget-content --> 
