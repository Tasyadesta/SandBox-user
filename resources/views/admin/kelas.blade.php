                           ...
                           @csrf
                               <div class="modal-body">
                                ...
                                <input type="hidden" name="id" value="{{$kelas->id}}">
                                 <div class="from-group">
                                     <label class="control-label" for="nm_brg" style="color: black"> Nama Kelas: </label>
                                     <input type="text" name="nama_kelas" class="from-control" id="nm_brg" style="color: black" value="{{ $kelas->nama_kelas }}" required>
                                 </div>
                                 <div class="from-group">
                                   <label class="control-label" for="nm_brg" style="color: black"> Keterangan: </label>
                               ...
                               <div class="from-group">
                                 <label class="control-label" for="nm_brg" style="color: black"> Harga: </label>
                                 <input type="text" name="harga" class="from-control" id="nm_brg" style="color: black" value="{{ $kelas->harga }}" required>
                             </div>
