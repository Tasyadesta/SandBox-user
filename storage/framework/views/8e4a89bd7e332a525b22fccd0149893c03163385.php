          ...
          <div class="widget widget-table action-table">
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php $__currentLoopData = $dataOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($kelas->id); ?></td>
                    <?php $__currentLoopData = $dataUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($k->id == $kelas->user_id): ?>
                    <td> <?php echo e($k->id); ?> </td>
                    <td> <?php echo e($k->name); ?> </td>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td><?php echo e($kelas->nama_order); ?></td>
                    <td> <?php echo e($kelas->harga); ?> </td>
                    <td> <?php echo e($kelas->status); ?> </td>
                               ...
                               <div class="modal-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo e($kelas->id); ?>">
                                 <div class="from-group">
                                    <label class="control-label" for="status" style="color: black">Status Pembayaran: </label>
                                     <select class="from-control" name="status" style="color: black">
                                     
                                        <option value="Belum Bayar" style="color: black">Belum Bayar</option>
                                        <option value="On Progress" style="color: black">On Progress</option>
                                        <option value="Sukses" style="color: black">Sukses</option>
...
<?php /**PATH F:\polos\resources\views/admin/order.blade.php ENDPATH**/ ?>