               ...
               <div class="row">
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                       <li> <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 underline nav-link">Dashboard</a> </li>
                    <?php else: ?>
                      <li>  <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 underline nav-link">Log in</a> </li>

                        <?php if(Route::has('register')): ?>
                     <li>    <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 underline nav-link">Register</a> </li>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\Iskandar\Documents\GitHub\laravelpolos\resources\views/master/dashboard.blade.php ENDPATH**/ ?>