                   ...
                   <?php echo csrf_field(); ?>
                       <div class="modal-body">
                         ...
                         <div class="from-group">
                             ...
                             <input type="text" name="nama_kelas" class="from-control" id="nm_brg" style="color: black" required>
                         </div>
                         <div class="from-group">
                       ...
                       <div class="from-group">
                         <label class="control-label" for="nm_brg" style="color: black"> Harga: </label>
                         <input type="text" name="harga" class="from-control" id="nm_brg" style="color: black" required>
                     </div>
                           ...
                           <?php echo csrf_field(); ?>
                               <div class="modal-body">
                                ...
                                <input type="hidden" name="id" value="<?php echo e($kelas->id); ?>">
                                 <div class="from-group">
                                     <label class="control-label" for="nm_brg" style="color: black"> Nama Kelas: </label>
                                     <input type="text" name="nama_kelas" class="from-control" id="nm_brg" style="color: black" value="<?php echo e($kelas->nama_kelas); ?>" required>
                                 </div>
                                 <div class="from-group">
                                   <label class="control-label" for="nm_brg" style="color: black"> Keterangan: </label>
                               ...
                               <div class="from-group">
                                 <label class="control-label" for="nm_brg" style="color: black"> Harga: </label>
                                 <input type="text" name="harga" class="from-control" id="nm_brg" style="color: black" value="<?php echo e($kelas->harga); ?>" required>
                             </div>
...
<?php /**PATH F:\polos\resources\views/admin/kelas.blade.php ENDPATH**/ ?>